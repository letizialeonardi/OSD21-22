...
do
	$PROG $PAR > log_$count &  #N.B. mandando in esecuzione in background possiamo provare anche le soluzioni dell'esercizio 3 senza che al primo caso di deadlock si debba usare il ^C e quindi abortire l'esecuzione del programma e quindi anche dello script
